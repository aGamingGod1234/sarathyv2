...
export default function InsightsPage() {
  ...
  if (profile?.plan_tier !== 'plus') {
    return (
      <PlusLocked
        active="story"
        title="Financial DNA is a Plus planning tool"
        body="Financial DNA needs enough personal context to explain patterns, trends, and behavior without staying generic."
      />
    )
  }
